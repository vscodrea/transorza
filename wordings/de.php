<?php
	...
	$wordingArray['head_subtitle'] = 'Warentransport';
	...
	$wordingArray['head_menu_tc'] = 'AGB';
	$wordingArray['head_menu_language'] = 'Deutsch';
	$wordingArray['head_menu_flag_path'] = 'de-flag-icon.png';
    
       //header meta info
    $wordingArray['meta_description_home'] = 'Trans Orza GmbH. LKW-Transport-Unternehmen mit Sitz in Kreis Maramures, Rumänien';
	$wordingArray['meta_description_about_us'] = 'Trans Orza GmbH. Lage & Kontaktinfo';
    $wordingArray['meta_description_photo_gallery'] = 'Trans Orza GmbH. Bildergalerie';
    $wordingArray['meta_description_our_services'] = 'Trans Orza GmbH. Unsere Dienstleistungen.';
    $wordingArray['meta_description_contact'] = 'Trans Orza GmbH. Kontact form';
    $wordingArray['meta_description_terms_and_conds'] = 'Trans Orza GmbH. AGB';
    ...
    $wordingArray['page_title_terms_and_conds'] = 'AGB';
    $wordingArray['page_title_video'] = 'Video';
	
	//home page
	$wordingArray['page_home_title'] = 'TRANS ORZA GmbH';
	$wordingArray['page_home_fb_text'] = 'Trans Orza auf Facebook';
	...
	$wordingArray['page_home_address'] = 'Giuleşti Nr 450, Kreis Maramureş Rumänien<br/> Postleitzahl: 437160';
	...
	$wordingArray['page_photo_gallery_title'] = 'Bildergalerie';
	
	$wordingArray['page_contact_title'] = 'Firmeninfos';
	$wordingArray['page_contact_label_company_name'] = 'Name';
	$wordingArray['page_contact_label_company_address'] = 'Adresse';
	$wordingArray['page_contact_text_company_address'] ='Gemeinde Giuleşti, Dorf Giuleşti Nr. 450<br>Kreis Maramureş';
	...
	$wordingArray['page_form_message_field'] = 'Nachricht';
	
	//terms&contitions page
	$wordingArray['page_terms_cond_title'] = 'AGB';
	$wordingArray['page_terms_cond_text'] = 'Datenschutz';
